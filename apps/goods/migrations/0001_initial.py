# Generated by Django 2.2.16 on 2020-11-25 02:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foods_num', models.IntegerField(default=0, verbose_name='库存数')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(default='', help_text='类别coede', max_length=30, verbose_name='类别code')),
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('parent_category', models.ForeignKey(blank=True, help_text='父目录', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sub_cat', to='goods.GoodsCategory', verbose_name='父级类目')),
            ],
            options={
                'verbose_name': '商品类别',
